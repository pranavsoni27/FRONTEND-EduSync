...
const StudentDashboard = ({ user }) => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [user, results, joinedCourses, selectedCourse, loading, loadingCourse, courseContents, assessments, timeLeft, answers, showAssessmentModal, handleSubmitAssessment]);
